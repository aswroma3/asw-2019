...
* eseguire lo script `start-infrastructure.sh` 
...
Per eseguire l'applicazione (dopo la *Preparazione*), vanno utilizzate tre (o più) finestre (terminali) diverse: una per il **server** del servizio dei ristoranti, una per l'**ascoltatore** di eventi ed una per il **produttore** di comandi. 
