...
che esemplificano la comunicazione interprocesso basata su **socket**: 
...
2. sulla finestra **client** 
   ...
   b. eseguire il comando `gradle client:run` oppure il comando `gradle client:run --args 10.11.1.101` 
      (`10.11.1.101` è l'indirizzo IP del nodo **dev**, in cui è in esecuzione il **server**) 
