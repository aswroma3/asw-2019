...
Questo progetto è una semplice applicazione con un produttore di messaggi ed un consumatore di messaggi.
...
Per eseguire l'applicazione (dopo la *Preparazione*), vanno utilizzate due (o più) finestre (terminali) diverse: una per il **consumatore** ed una per il **produttore**. 
