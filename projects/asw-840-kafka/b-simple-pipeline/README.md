...
Questo progetto è una semplice applicazione con un produttore di messaggi, un filtro di messaggi ed un consumatore di messaggi.
...
Per eseguire l'applicazione (dopo la *Preparazione*), vanno utilizzate tre (o più) finestre (terminali) diverse: una per il **consumatore**, una per il **filtro** ed una per il **produttore**. 
