...
public class RestaurantServiceGrpcServer {
    ...
    private class RestaurantServiceImpl extends RestaurantServiceGrpc.RestaurantServiceImplBase {
        ...
        @Override
        public void createRestaurantMenu(CreateRestaurantMenuRequest req, StreamObserver<CreateRestaurantMenuReply> responseObserver) {
            Long restaurantId = req.getRestaurantId(); 
			
			List<MenuItem> menuItems = 
				req.getMenuItemsList()
					.stream() 
        ...
        @Override
        public void getRestaurantMenu(GetRestaurantMenuRequest req, StreamObserver<GetRestaurantMenuReply> responseObserver) {
            Long restaurantId = req.getRestaurantId(); 
